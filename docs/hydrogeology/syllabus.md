...
| 6    | 2/10/26  | **Darcy Flow in 2D (Ch 4.1–4.5)**             | Three-Point Gradient + Darcy Velocity: Compute gradients, q, v, anisotropy effects in Python                                   | **Anisotropy & Heterogeneity (Ch 4.6–4.9)**                 | 4.1–4.6         | Ch 4 (3, 6, 7, 8, 9)        |                                                              |
| 7    | 2/17/26  | **Flow Nets (Ch 4.9 - 4.11)**                        | Digital Flow Nets: Laplace solver in Python; contouring potentials; flow net interpretation                                     | **Midterm Review**                    | 4.7–4.9         | No HW     |                                                              |
| 8    | 2/24/26  | **MIDTERM**                                   | MIDTERM                                                                                                                       | **Refraction, Steady flow in Confined/Unconfined Aquifers (Ch 4.12 - 4.14)**                                             | —               | —                       |                                                              |
| 9    | 3/3/26   | Spring Break (no class)                       | —                                                                                                                             | —                                                           | —               | —                       |                                                              |
| 10   | 3/10/26  | **Radial Flow, Transient Flow (Ch 5.1–5.4)**           | Well Hydraulics: Fit Thiem equation using numpy, estimate T and K from pumping data                                            | **Steady-State Flow (Ch 5.5)**         | 5.1–5.5         | 2 Calculation Problems        | Project scope/narrative intro, 2–3 students/group  |
| 11   | 3/17/26  |  **Slug tests, Cooper–Jacob Approximation (Ch 5.6)** | GMS MOOSE - Lab 1                                              | **Capillary Fringe, Soil Moisture (Ch 6.3-6.4)**                 | 5.6 - 6         | HW: Capillary rise     |                                                              |
| 12   | 3/24/26  | **Soil Water, Unsaturated Flow (Ch 6.5-6.6)**                      | GMS Modflow - Lab 2 | **Water table recharge (Ch 6.7)**                              | 6               | Designed HW        |                                                              |
| 13   | 3/31/26  | **Aquifer Testing (Ch 7)**                    | GMS Modflow - Lab 3                                                                              | **Step-Drawdown Methods (Ch 7)**                           | 7               | Designed HW        | ZOOM                                                         |
| 14   | 4/7/26   | **Springs (ch 7.5), Water Chemistry (Ch9)** | GMS Modpath - Lab 4                 | **Model Calibration (Ch 8)**                               | 8               | Ch 8 (1, 3, 7, 9)        |                                                              |
| 15   | 4/14/26  | **Review**                                     | Group final project - refine                                        | **GMS Modflow - Final Presentation**                     | —               | —                       |                                                              |
| 16   | 4/21/26  | **FINAL EXAM 10:15 - noon, Dillman320**                                 | —                                                                                                                             | —                                                           | —               | —                       |                                                              |
