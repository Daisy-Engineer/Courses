...
| 2    | 1/13/26  | **Hydrographs (Ch 2.5–2.8)**                 | Hydrograph Analysis: Baseflow separation, smoothing, runoff volume, hydrograph plotting in Python                             | **Runoff, Recharge, Manning (Ch 2.9–2.14)**                 | 2.9–2.14        | Ch 2 (5, 7, 11, 13)      |                                                              |
