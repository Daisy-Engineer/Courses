...
| 10   | 3/10/26  | **Steady-State Wells (Ch 5.1–5.2)**           | Well Hydraulics: Fit Thiem equation using numpy, estimate T and K from pumping data                                            | **Specific Capacity & Transmissivity (Ch 5.3–5.4)**         | 5.1–5.4         | Ch 5 (1, 3, 5, 7)        | Project kickoff (3–4 students). Topic assigned by Week 12.  |
