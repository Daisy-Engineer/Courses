...
| 7    | 2/17/26  | **Flow Nets (Ch 4.9 - 4.11)**                        | Digital Flow Nets: Laplace solver in Python; contouring potentials; flow net interpretation                                     | **Midterm Review**                    | 4.7–4.9         | Ch 4 (9, 11, 13, 15)     |                                                              |
