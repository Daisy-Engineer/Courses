...
| Week | Date     | Tue Lecture                                 | Tue Lab (Python-based, brief description)                                                                                     | Thu Lecture                                                | Fetter Chapters | HW                     | Notes                                                        |
|------|----------|-----------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|-----------------|-------------------------|--------------------------------------------------------------|
...
| 3    | 1/20/26  | **Porosity & Void Ratio (Ch 3.1–3.3)**        | Porosity & Grain Size: Compute D10–D60, grain-size curves using numpy, porosity estimation                                     | **Specific Yield & Retention (Ch 3.13–3.33)**               | 3.1–3.33        | Ch 3 (1, 3, 9, 15)       |                                                              |
...
| 10   | 3/10/26  | **Steady-State Wells (Ch 5.1–5.4)**           | Well Hydraulics: Fit Thiem equation using numpy, estimate T and K from pumping data                                            | **Specific Capacity & Transmissivity (Ch 5.1–5.4)**         | 5.1–5.4         | Ch 5 (1, 3, 5, 7)        | Project kickoff (3–4 students). Topic assigned by Week 12.  |
