...
| 4    | 1/27/26  | **Hydraulic Conductivity Measurement, Water Table (Ch 3.5-3.6)**           | K Measurement: Compute K from constant-head & falling-head tests; curve fitting using scipy                                    | **Aquifers, Potentiometric Surface (Ch 3.7-3.8)**                         | 3.5-3.8             | Ch 3 (5, 7, 17, 19)      |                                                              |
| 5    | 2/3/26   | **Aquifer Characteristics; Hydraulic Gradient (Ch 3.9-3.12)**            | Potentiometric Surface Mapping: Compute heads, interpolate grids, contour maps, flow direction                                 | **Class cancellation due to Winter Carnival**      | 3.9–3.12        | Ch 3 (11, 13)            |                                                              |
