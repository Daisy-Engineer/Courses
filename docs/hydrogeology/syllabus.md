...
|------|----------|-----------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|-----------------|-------------------------|--------------------------------------------------------------|
| 1    | 1/6/26   | **Ch 1: Introduction**  | Python + Hydro Data Analytics: Jupyter intro, units, load precipitation–streamflow data, compute annual water balance | **Ch 2.5–2.8: Water Balance, Precipitation, ET, Infiltration, Recharge**   | Ch 1; 2.5–2.8   | Ch 1 (1,3,5,10); Ch 2 (1) |                                                              |
