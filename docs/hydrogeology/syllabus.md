...
| 4    | 1/27/26  | **Hydraulic Conductivity Measurement (Ch 3.5)**           | K Measurement: Compute K from constant-head & falling-head tests; curve fitting using scipy                                    | **Water Table, Aquifers (Ch 3.6)**                         | 3.4             | Ch 3 (5, 7, 17, 19)      |                                                              |
